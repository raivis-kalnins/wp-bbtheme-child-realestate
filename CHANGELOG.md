...
## 3.7.0 - 2026-08-29
- Migrated the property search homepage experience to the reusable WP BBuilder Sector Finder block while retaining the existing property directory/AJAX model.
- Keeps the v3.5 responsive header, property single/archive, form and editorial improvements.
## 3.5.0 - 2026-08-29
- Added premium Property Journal AJAX archive and editorial single-post presentation.
- Reworked mobile header behaviour so hamburger and dark-mode controls appear only below 992px without desktop overlap.
- Normalised property/contact/newsletter form grids, field heights, checkbox/radio sizing and responsive stacking.
...
## 3.1.0 - 2026-08-28
- Added dedicated property archive/single templates, richer filters and responsive listing detail presentation.
- Added Buy/Rent/Services editable mega-menu content and repaired all starter patterns.

## 3.0.0 — 2026-08-28

- Rebuilt child presentation/source structure and production build.
- Upgraded property finder/card/detail presentation and responsive states.
- Added Polylang registration for property content and taxonomy.
- Reworked demo/pattern layout to proper BBuilder + Bootstrap containers and Swiper area guides.
- Added suite header/footer, dark-mode, mega-menu, AJAX search and newsletter presentation.
- Removed child-theme `clamp()` usage and stale assets.
